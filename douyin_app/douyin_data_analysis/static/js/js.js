$(function (){
    ...
    function echarts_6(data) {
        ...
        var option = {
            color: [ '#0fa0d6','#bb1124', '#a8b12c', '#21a118'],
            tooltip: {},
            legend: {
            ...
            series: [
                {
                    ...
                    center: ['50%', '42%'],
                    radius: ['40%', '60%'],
                    color: ['#bb1124',  '#a8b12c', '#182aa1','#065aab',  '#0696ab', '#06b4ab', '#06c8ab', '#06dcab', '#06f0ab'],
                    label: {show: false},
                    labelLine: {show: false},
